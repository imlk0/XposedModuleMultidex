...
final class MultiDexExtractor {
    ...
    private static final String TAG = XMMultiDex.TAG;
    ...
    private static final String LOCK_FILENAME = "XMMultiDex.lock";
     ...
     *                     secondary dex files
     */
    static List<File> load(String module_path,  File dexDir) throws IOException {
        Log.i(TAG, "MultiDexExtractor.load(" + module_path);
        final File sourceApk = new File(module_path);
